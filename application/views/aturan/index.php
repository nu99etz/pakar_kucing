                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div style="float: right;">
                            <button action="<?php echo base_url(); ?>aturan/create" type="button" class="btn-add btn btn-flat btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</button>
                        </div>
                        <br/>
                        <br/>
                        <table id="aturan" url="<?php echo base_url(); ?>aturan/ajax" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Aturan</th>
...
<script>
    let _table = $('#aturan');
    let _url = $('#aturan').attr('url');
    let _modal = $('#modal_aturan');
    ...
    $(document).on('submit', 'form#importAturan', function() {
        event.preventDefault();
        let _url = $(this).attr('action');
        let _data = new FormData($(this)[0]);
        send((data, xhr = null) => {
