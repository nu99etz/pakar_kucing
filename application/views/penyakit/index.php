...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Master Penyakit
            <small>Master Penyakit</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Master Penyakit</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Master Penyakit</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <br />
                        <br />
                        <table id="penyakit" url="<?php echo base_url(); ?>penyakit/ajax" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Kode Penyakit</th>
...
$data['modal_id'] = 'modal_penyakit';
$data['modal_size'] = 'lg';
$data['modal_title'] = 'Form Penyakit';
...
<script>
    let _table = $('#penyakit');
    let _url = $('#penyakit').attr('url');
    let _modal = $('#modal_penyakit');
    ...
    $(document).on('submit', 'form#penyakit', function() {
    ...
    $(document).on('submit', 'form#importPenyakit', function() {
        event.preventDefault();
        let _url = $(this).attr('action');
        let _data = new FormData($(this)[0]);
        send((data, xhr = null) => {
